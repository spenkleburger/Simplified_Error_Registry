...
Source URL: https://cursor.com/docs/agent/chat/commands
...
Team commands: Created by team admins in the [Cursor Dashboard](https://cursor.com/dashboard?tab=team-content&section=commands) and automatically available to all team members
...
Navigate to the [Team Content dashboard](https://cursor.com/dashboard?tab=team-content&section=commands)
